...
| 23. 后续 P0 工单                                 | in_progress | 依赖已解锁：**PRI-001**（可比样本查询与市场价基线，依赖 DB-003/DB-005/PROC-004✅）→ 解锁价格分析链路。**FND-001 剩余**（ADR-001/ADR-002）可随时补。COL-002/COL-004 被 EXT-001 阻塞；API 链路依赖 FND-006✅ 但需 API-001 初始化。 |
