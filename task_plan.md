...
| 18. 后续 P0 工单                             | in_progress | 依赖已解锁：**PROC-003**（商品去重与主记录更新，依赖 PROC-001/DB-003✅）、**COL-003**（调度锁/配额，依赖全✅，Redis 已可由 docker 提供）、**DB-005**（P1）。FND-001 剩余（ADR-001/ADR-002）可随时补；COL-002 被 EXT-001 阻塞。 |
