...
| 22. 后续 P0 工单                                 | in_progress | 依赖已解锁：**DB-005**（P1 索引/迁移/种子，依赖 DB-001~004✅）→ 解锁 **PRI-001**（市场价基线）。**FND-001 剩余**（ADR-001/ADR-002）可随时补。COL-002/COL-004 被 EXT-001 阻塞；NTF 链路依赖 PRI/API。 |
