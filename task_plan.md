...
| 21. 后续 P0 工单                                 | in_progress | 依赖已解锁：**PRI-001**（可比样本查询与市场价基线，依赖 DB-003/DB-005⛔/PROC-004）——DB-005 为 P1 但 PRI-001 依赖它；可先做 **DB-005**（P1：索引/迁移/种子）或 **FND-001 剩余**（ADR-001/ADR-002）。COL-002/COL-004 被 EXT-001 阻塞。 |
