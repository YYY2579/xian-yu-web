...
| 19. 后续 P0 工单                                 | in_progress | 依赖已解锁：**PROC-003**（商品去重与主记录更新，依赖 PROC-001/DB-003✅）、**DB-005**（P1）、**COL-004**（采集 worker 消费，依赖 COL-002⛔ EXT-001 阻塞）。FND-001 剩余（ADR-001/ADR-002）可随时补。 |
